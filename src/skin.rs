...
impl Skin {
    ...
    /// Add a skin to this skin. Typically used on a newly created skin (via [`Skin::new`]) to
    /// create conglomerate skins.
    ///
    /// # Safety
    ///
    /// Skins must all originate from the same [`SkeletonData`]. There is no safe version of this
    /// function.

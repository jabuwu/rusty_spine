                                ...
                                match len {
                                    4 => {
                                        ...
                                        *ptr2 = ((uc | 0x80 as c_int as c_uint)
                                            ...
                                            as c_char;
                                        uc >>= 6 as c_int;
                                        current_block_38 = 1872546583673537734;
                                    }
                                    3 => {
                                        current_block_38 = 1872546583673537734;
                                    }
                                    2 => {
                                        current_block_38 = 14458908414828666963;
                                    }
                                    1 => {
                                        current_block_38 = 11653756310905352348;
                                    }
                                    _ => {

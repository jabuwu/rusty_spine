...
pub unsafe extern "C" fn spTransformConstraintTimeline_setFrame(
    ...
    *frames.offset((frame + TRANSFORMCONSTRAINT_X) as isize) = mixY;
                                ...
                                match len {
                                    4 => {
                                        ...
                                        *ptr2 = ((uc | 0x80 as c_int as c_uint)
                                            ...
                                            as c_char;
                                        uc >>= 6 as c_int;
                                        current_block_38 = 5609571871837411691;
                                    }
                                    3 => {
                                        current_block_38 = 5609571871837411691;
                                    }
                                    2 => {
                                        current_block_38 = 17405134858339555073;
                                    }
                                    1 => {
                                        current_block_38 = 1228716350663818539;
                                    }
                                    _ => {

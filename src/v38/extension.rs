...
use crate::v38::c::{c_int, c_void, size_t};
use crate::v38::c_interface::NewFromPtr;
use crate::v38::{
    atlas::AtlasPage,
...
/// ```
///
/// If using the [`SimpleDrawer`](`crate::v38::draw::SimpleDrawer`) or
/// [`CombinedDrawer`](`crate::v38::draw::CombinedDrawer`), the texture can be acquired from
/// [`SimpleRenderable::attachment_renderer_object`](`crate::v38::draw::SimpleRenderable::attachment_renderer_object`)
/// or
/// [`CombinedRenderable::attachment_renderer_object`](`crate::v38::draw::CombinedRenderable::attachment_renderer_object`)
/// respectively.
///
/// If using the [`SkeletonController`](`crate::v38::controller::SkeletonController`), see
/// [`SkeletonRenderable::attachment_renderer_object`](`crate::v38::controller::SkeletonRenderable::attachment_renderer_object`)
/// or
/// [`SkeletonCombinedRenderable::attachment_renderer_object`](`crate::v38::controller::SkeletonCombinedRenderable::attachment_renderer_object`)
///
/// ```
/// # #[path="./test.rs"]
/// # mod test;

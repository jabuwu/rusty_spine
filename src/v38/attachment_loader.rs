...
///
/// Currently only supports [`Atlas`](`crate::v38::Atlas`) based attachments.
#[derive(Debug)]
...
impl AttachmentLoader {
    /// The spine runtime offers a default [`AttachmentLoader`](`crate::v38::AttachmentLoader`) that
    /// loads attachments from an [`Atlas`](`crate::v38::Atlas`).
    #[must_use]
    ...
    /// Creates an [`Attachment`](`crate::v38::Attachment`) of a specified type.
    ///
    /// # Errors
    ///
    ...
    /// Convenience function for creating a [`RegionAttachment`](`crate::v38::RegionAttachment`).
    ///
    /// # Errors
    ///
    /// Returns [`SpineError::CreationFailed`] if creating the attachment failed.

...
/// Stores the setup pose for a [`TransformConstraint`](`crate::v38::TransformConstraint`).
///
...
impl TransformConstraintData {
    ...
    c_accessor!(
        ...
        /// [`Skeleton::update_world_transform`](`crate::v38::Skeleton::update_world_transform`).
        order,
        order,
        i32
    );
    c_accessor_bool!(
        /// When true,
        /// [`Skeleton::update_world_transform`](`crate::v38::Skeleton::update_world_transform`) only

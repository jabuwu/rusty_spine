...
use super::c_interface::{CTmpRef, NewFromPtr, SyncPtr};
use super::texture_region::TextureRegion;
use super::{
    c::{spAtlas, spAtlasPage, spAtlas_create, spAtlas_dispose},
    error::SpineError,
};
use atlas::*;
use crate::v42::c::c_int;
...
pub mod atlas {
    ...
    use crate::v42::c_interface::from_c_str;
